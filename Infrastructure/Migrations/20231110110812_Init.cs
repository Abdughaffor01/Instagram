        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SendMessageDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ApplicationUserId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Messanges", x => x.MessageId);
                    table.ForeignKey(
                        name: "FK_Messanges_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusStory = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    ApplicationUserId = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostLikeUsers", x => new { x.UserId, x.PostLikeId });
                    table.ForeignKey(
                        name: "FK_PostLikeUsers_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostViewUsers", x => new { x.UserId, x.PostViewId });
                    table.ForeignKey(
                        name: "FK_PostViewUsers_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messanges_ApplicationUserId",
                table: "Messanges",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostLikeUsers_ApplicationUserId",
                table: "PostLikeUsers",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PostLikeUsers_PostLikeId",
                table: "PostLikeUsers",
                column: "PostLikeId");

            migrationBuilder.CreateIndex(
                name: "IX_PostViewUsers_ApplicationUserId",
                table: "PostViewUsers",
                column: "ApplicationUserId");
